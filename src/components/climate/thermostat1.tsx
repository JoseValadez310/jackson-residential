...
const Thermostat5 = () =>{
    ...
    const tempFB:string = "200"

    const setpointFBHeat:string = "201"
    const setpointFBCool:string = "202"

    
    const systemOff:string = "402"
    const heat:string = "403"
    const cool:string = "404"
    const auto:string = "405"
    const fanAuto:string = "406"
    const fanOn:string = "407"

    const increaseTempSend:string = "408"
    const decreaseTempSend:string = "409"


    const dualAutoHeatSpInc:string = "410"
    const dualAutoHeatSpDec:string = "411"

    const dualAutoCoolSpInc:string = "412"
    const dualAutoCoolSpDec:string = "413"
