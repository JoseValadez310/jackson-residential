...
const Thermostat1 = () =>{
    ...
    useEffect(() => {
        console.log("Grabbing data in thermo 1")
        ...
        return() =>{
            ...
            console.log("Grabbing data in thermo 1 return")
                        ...
                        <div className="thermostat">
                            ...
                            <div className="thermostat_controls_two">
                                <div className="thermostat_mode"> 
                                    <button className="" onClick={() => enableModal("mode")}>  
