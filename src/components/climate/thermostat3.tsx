...
const Thermostat5 = () =>{
    ...
    const tempFB:string = "222"
    const setpointFBHeat:string = "223"
    const setpointFBCool:string = "224"

    
    const systemOff:string = "432"
    const heat:string = "433"
    const cool:string = "434"
    const auto:string = "435"
    const fanAuto:string = "436"
    const fanOn:string = "437"
  
    const increaseTempSend:string = "438"
    const decreaseTempSend:string = "439"


    const dualAutoHeatSpInc:string = "440"
    const dualAutoHeatSpDec:string = "441"

    const dualAutoCoolSpInc:string = "442"
    const dualAutoCoolSpDec:string = "443"
