...
const Thermostat5 = () =>{
    ...
    const setpointFBHeat:string = "234"
    const setpointFBCool:string = "235"
    ...
    const dualAutoHeatSpInc:string = "455"
    const dualAutoHeatSpDec:string = "456"

    const dualAutoCoolSpInc:string = "457"
    const dualAutoCoolSpDec:string = "458"
