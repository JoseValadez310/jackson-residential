...
*/
    ...
    useEffect(() => {
        ...
        const roomMute    = window.CrComLib.subscribeState("b","521",(value: boolean) => {setRoomMute(value);});
    ...
    // Power menu for current room
        const powerMenu = (id:string) =>{
            if(id==="menu"){
                ...
                console.log("Turning off room join", 26)
                setTvPowerMenu(!tvPowerMenu)
