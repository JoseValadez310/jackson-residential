...
*/
    ...
    const audio_volume_join   = "110"
    const audio_increase_join = "542"
    const audio_mute_join     = "541"
    ...
    return (
        ...
        <div className="generic_room" id="arcade_special">
            ...
            <div className="room_back_corner" >
                <Link to={"/RoomsDashboard"}  state ={{previousLocation:"3"}} onTouchEnd={() => closeOutPowerOption} > 
            ...
            <div className="nav">
                        ...
                        <Link to={"/AudioDashboard"}  state={{lastLoc:"arcade",roomId:"arcade", activity: activeSource}}                 className={musicOption? "btn_selected" : "btn_not_selected"}   >  <img src={music}   /> </Link>
            ...
            <div className={tvPowerMenu? "power_menu_overlay" : "hide_power_menu_overlay"} >
                <div className="power_menu">
                    ...
                    <div className="arcade_yes_btn">                    
                            ...
                            <button style={{width:"100%", height:"100%"}} className="yes_reboot" onTouchEnd={()=> (multiZoneOff("zone2") , display_tile())}>  
                            <p style={{width:"100%"}}>TV #2 </p> 
                            </button> 

                            <button style={{width:"100%", height:"100%"}} className="yes_reboot" onTouchEnd={()=> (multiZoneOff("zone3") , display_tile())}> 
            ...
            <div className={tvOptions? "generic_media_container" : "media_off"} id="all_source_layout" >
                    ...
                    <div className={active_media? "controller_layout": "media_off"}>
                        ...
                        <button className={media6? "btn_circle": "media_off"} id="reboot_button" onTouchEnd={()=>appleTvRebootMenu("menu")}> 
                            <p> REBOOT </p>
                        </button>
