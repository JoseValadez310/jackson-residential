...
*/
    ...
    const light_1_join = "292"
    const light_2_join = "293"
    const light_3_join = "294"
    const light_4_join = "295"
    const light_5_join = "296"
    const light_6_join = ""
    const light_7_join = ""
    const light_8_join = ""


    const light_1_name:string = "Front Sconces"
    const light_2_name:string = "Front Chandelier"
    const light_3_name:string = "Interior Chandelier"
    const light_4_name:string = "Party"
    const light_5_name:string = "Nitche"
