...
*/
    ...
    const light_1_join = "299"
    const light_2_join = "300"
    const light_3_join = "301"
    const light_4_join = "302"
    const light_5_join = "303"
    const light_6_join = ""
    const light_7_join = ""
    const light_8_join = ""


    const light_1_name:string = "Madison"
    const light_2_name:string = "Logan"
    const light_3_name:string = "Hudson"
    const light_4_name:string = "Top Hall"
    const light_5_name:string = "Kids Hall"
