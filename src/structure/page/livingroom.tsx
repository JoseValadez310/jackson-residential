...
*/
    ...
    const light_1_join = "315"
    const light_2_join = "316"
    const light_3_join = "317"
    const light_4_join = "318"
    const light_5_join = "319"
    const light_6_join = ""
    const light_7_join = ""
    const light_8_join = ""


    const light_1_name:string = "Living"
    const light_2_name:string = "Perimeter"
    const light_3_name:string = "Chandelier"
    const light_4_name:string = "Down Lights"
    const light_5_name:string = "Sconces"
