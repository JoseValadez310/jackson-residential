...
*/
    ...
    const audio_volume_join   = "106"
    const audio_mute_join     = "525"
    const audio_increase_join = "526"
    const audio_decrease_join = "524"
        ...
        <div className="generic_room">
            ...
            <div className="nav_container" id ={active_media? "mobile_display_none" : "mobile_display_contemt" } >
                ...
                <div className="nav">
                        ...
                        <Link to={"/AudioDashboard"}    state={{ lastLoc:"familyroom",roomId:"family", activity: activeSource}}          className={musicOption? "btn_selected" : "btn_not_selected"}   >  <img src={music}   /> </Link>
