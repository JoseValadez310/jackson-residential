        ...
        <div className="generic_room">
            ...
            <div className="nav_container" id ={active_media? "mobile_display_none" : "mobile_display_contemt" } >
                ...
                <div className="nav">
                        ...
                        <Link to={"/AudioDashboard"} state={{roomId:"dining", activity: activeSource, lastLoc:"dinningroom"}}             className={musicOption? "btn_selected" : "btn_not_selected"}   >  <img src={music}   /> </Link>
