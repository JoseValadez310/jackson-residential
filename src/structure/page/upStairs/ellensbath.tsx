...
*/
    ...
    const audio_volume_join   = "105"
    const audio_mute_join     = "522"
    const audio_increase_join = "521"
    const audio_decrease_join = "520"
        ...
        <div className="generic_room">
            ...
            <div className="nav_container" id ={active_media? "mobile_display_none" : "mobile_display_contemt" } >
                ...
                <div className="nav">
                        ...
                        <Link to={"/AudioDashboard"}     state={{lastLoc:"ellensbath",roomId:"ellensBath", activity: activeSource}}         className={musicOption? "btn_selected" : "btn_not_selected"}   >  <img src={music}   /> </Link>
