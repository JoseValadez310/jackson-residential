    ...
    return (
        ...
        <div className="generic_room">
            ...
            <div className={active_media? "media_off":"room_sources_container"}>
                            ...
                            <div className="display_none" id= {activeSource === 5 ? 'active_source' : 'not_active'} onClick={()=>playSource('media3')}>
                                <div className="img_container">
                            ...
                            <div className="display_none" id= {activeSource === 8 ? 'active_source' : 'not_active'} onClick={()=>playSource('media6')}>
                                <div className="img_container">
