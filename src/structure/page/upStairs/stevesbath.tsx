...
*/
    const roomName = "Steve's Bathroom"
/*
---------------------------------------------------------------------------- Room dashboard apps 
*/
...
*/
    ...
    useEffect(() => {
        ...
        const media3 = window.CrComLib.subscribeState("b","9",(value: boolean) => {setMedia3(value);});  // DTV House 1
        ...
        return () => {
            ...
            window.CrComLib.unsubscribeState("b","9",media3)
...
{active_media?
            ...
            <Link className="back_btn_container" to={"/RoomsDashboard"} state={{previousLocation: 'Up Stairs'}} onClick={() => closeOutPowerOption} > 
                <button className="back_button" >
                    <img src={menu}/>
                </button>
            </Link>  
